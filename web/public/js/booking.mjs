                ...
                {   
                    ...
                    if (reg_response.ok) {
                        ...
                        if (response.ok)
                        {
                            ...
                            {
                                popup.innerHTML = "";
                                h1.innerHTML = h1.innerHTML = `Успешно забронирован стол №${ i + 1 } ${ start_date.toLocaleDateString() } ${ start_date.toLocaleTimeString() } по ${ booked_date.toLocaleDateString() } ${ booked_date.toLocaleTimeString() }!`;
                                popup.appendChild(h1);
                            }, 3000);
                        }
                        else {
